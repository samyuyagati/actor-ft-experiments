...
python3 video_benchmark_debugging.py --video-path videos/husky.mp4 videos/husky.mp4 --failure --recovery app_lose_frames

# Simulate one failure about halfway through processing and with
# simulated application-level recovery that does not allow missing frames.
python3 video_benchmark_debugging.py --video-path videos/husky.mp4 videos/husky.mp4 --failure --recovery app_keep_frames
...
python3 video_benchmark_debugging.py --video-path videos/husky.mp4 videos/husky.mp4 --failure --checkpoint-freq 30 --recovery checkpoint
